...
| system.query_log | ✅ | `querylog_view_test.go::TestEnsureDuckLakeQueryLogViewContextCreatesView` | Live DuckLake view over native Postgres `querylog.query_log_entries`; not DuckLake snapshot data. |
